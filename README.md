...
The version in this repo is built for characters from [Lessons In Love](https://lessonsinlove.wiki/wiki/Main_Page)
an adult dating sim, but the sorter can be easily edited to create any custom sorter desired.
